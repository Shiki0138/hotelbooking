-- Supabase最終セットアップ（トリガーエラーを回避）

-- 1. 不足しているテーブルを作成（IF NOT EXISTSで安全に）
...
BEGIN
    ...
    RAISE NOTICE '作成されたテーブル: users, rooms, user_preferences, search_history, reviews, watchlist, availability_calendar, price_rules, realtime_inventory';
    RAISE NOTICE '作成されたビュー: luxury_deals_view, price_change_analysis';
END
$$;